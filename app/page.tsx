...
export default function LandingPage() {
  return (   
      <section className="max-w-7xl mx-auto flex flex-col items-center justify-center p-5">
        ...
        <p className="text-gray-400 p-2 tezt-sm font-sans">At Avatrix, brands can produce engaging, customizable video content featuring ultra-realistic avatars tailored to their identity.</p>
